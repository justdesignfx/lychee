export const en = {
  translation: {
    ...
    home: {
      ...
      textReveal: {
        text: {
          w1: { word: "We", font: "normal" },
          w2: { word: "are", font: "normal" },
          w3: { word: "creating", font: "italic" },
          w4: { word: "creative", font: "normal" },
          w5: { word: "content", font: "normal" },
          w6: { word: "on", font: "normal" },
          w7: { word: "new", font: "normal" },
          w8: { word: "media", font: "normal" },
          w9: { word: "platforms.", font: "normal" },
        },
        button: {
      ...
      stats: {
        ...
        black: {
          text: "Average view-to-follower ratio.",
        },
        small: "*These data are the results obtained from the analysis of 2022-2023 brand partnerships.",
      },
      moveOn: {
        buttons: {
          b1: {
