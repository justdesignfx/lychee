export const tr = {
  translation: {
    ...
    home: {
      ...
      textReveal: {
        text: {
          w1: { word: "Yeni", font: "normal" },
          w2: { word: "medya", font: "normal" },
          w3: { word: "platformlarında", font: "normal" },
          w4: { word: "kreatif", font: "italic" },
          w5: { word: "içerikler", font: "normal" },
          w6: { word: "üretiyoruz.", font: "normal" },
        },
        button: {
      ...
      stats: {
        ...
        black: {
          text: "Ortalama görüntüleme başına takipçi sayısı artışı.",
        },
        small: "*Bu veriler 2022-2023 marka iş birlikleri analizlerinden ortaya çıkan sonuçlardır.",
      },
      moveOn: {
        buttons: {
          b1: {
