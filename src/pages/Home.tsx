            ...
            <div className={s.screen} data-sliding-panel-unskew>
              <div className={cx(s.statC, s.blue)}>
                <h3 className={s.statText}>
                  ...
                  <span className={cx(s.asterisk, s.mil)}>*</span>
                </h3>
            ...
            <div className={s.screen} data-sliding-panel-unskew>
              <div className={cx(s.statC, s.pink)}>
                <h3 className={s.statText}>
                  ...
                  <span className={cx(s.asterisk, s.k)}>*</span>
                </h3>
        ...
        <section className={s.references}>
          ...
          <div className={s.oHiddenC}>
            <div className={s.logoGrid}>
              <div className={s.row}>
                <div className={cx(s.logoC, s.logoDisney)} data-logo-parallax data-speed-y="0.2" data-direction-y="-1">
                  <img className={s.img} src={logoDisney} alt="Company Logo" />
                </div>
                <div className={cx(s.logoC, s.logoAdidas)} data-logo-parallax data-speed-y="0.4" data-direction-y="-1">
                  <img className={s.img} src={logoAdidas} alt="Company Logo" />
                </div>
                <div className={cx(s.logoC, s.logoPhilips)} data-logo-parallax data-speed-y="0.4" data-direction-y="-1">
                ...
                <div className={cx(s.logoC, s.logoNestle)} data-logo-parallax data-speed-y="0.2" data-direction-y="-1">
              ...
              <div className={s.row}>
                <div className={cx(s.logoC, s.logoLoreal)} data-logo-parallax data-speed-y="0.5" data-direction-y="-1">
